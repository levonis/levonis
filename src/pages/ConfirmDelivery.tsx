...
import { Star, Loader2, ArrowRight, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background/95 backdrop-blur-sm">
      <main className="container mx-auto px-4 py-8 pt-24 max-w-3xl">
        ...
        <Card className="mb-6 border-green-500/50 bg-green-50/50">
          <CardContent className="py-6 text-center">
            <CheckCircle className="h-16 w-16 text-green-600 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-green-700 mb-2">تهانينا!</h2>
