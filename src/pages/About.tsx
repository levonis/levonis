...
const About = () => {
  ...
  const t = {
    ...
    ku: {
      ...
      ctaContact: 'پەیوەندی',
      story: 'چیرۆکمان',
      storyText: 'LEVONIS لە بەغدا دەستی پێکرد بۆ ئەوەی ببینە یەکەم سەرچاوە لە عێراق بۆ پرینتەری 3D. پسپۆڕی Bambu Lab و Resin ئین، Filaments و کەرەستە و پارچەی یەدەکمان هەیە، هەروەها گەیاندنی ئەلیکترۆنیات بە هەرزانترین نرخ.',
      timeline: 'گەشتمان',
      timelineList: [
      ...
      faqList: [
        { q: 'بریکاری فەرمی Bambu Lab ئین؟', a: 'بەڵێ، بریکاری فەرمی Bambu Lab لە عێراقین بە گەرەنتی تەواو.' },
