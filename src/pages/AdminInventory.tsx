...
import {
  ...
  ChevronRight, Trash2, X, Send, Palette, Settings2
} from 'lucide-react';
...
const GlassCard = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  <div className={`relative rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300 hover:border-white/[0.12] ${className}`}>
    {children}
  </div>
);
...
export default function AdminInventory() {
  ...
  return (
    <div className="min-h-screen relative" dir="rtl" style={{ background: 'linear-gradient(135deg, hsl(225 30% 6%), hsl(235 25% 10%), hsl(225 30% 6%))' }}>
      ...
      {/* Main Content */}
      <main className="relative z-10 transition-all duration-300" style={{ marginRight: sidebarOpen ? 236 : 80, padding: '24px' }}>
