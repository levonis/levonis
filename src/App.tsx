...
const AdminCommissionSettings = lazy(() => import("./pages/AdminCommissionSettings"));
      ...
      <main style={{ paddingTop: `${totalTopPadding}px` }}>
        <Suspense fallback={<SuspenseLoader />}>
          <Routes>
            ...
            <Route path={`${ADMIN_BASE_PATH}/commission-settings`} element={<AdminRoute><AdminCommissionSettings /></AdminRoute>} />
