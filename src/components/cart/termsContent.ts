...
const ar: TermsContent = {
  ...
  sections: [
    ...
    { title: 'الشحن والتسليم', paragraphs: ['يتم شحن الطابعات والملحقات عبر شركات شحن معتمدة، وقد يتم شحن بعض القطع أو الإكسسوارات جواً خلال مدة تقديرية لا تتجاوز أسبوعين، وبحد أدنى للشحن الجوي (1) كيلوجرام.', 'لا تتحمل المنصة مسؤولية أي تأخير ناتج عن الجهات الخارجية مثل شركات الشحن أو الجمارك.'] },
    { title: 'الضمان الأساسي', paragraphs: ['يبدأ الضمان الأساسي للطابعة من تاريخ إتمام عملية الشراء وليس من تاريخ الاستلام.', 'يشمل الضمان استبدال القطع التالفة فقط خلال فترة الضمان المعتمدة، ولا يشمل الأعطال الناتجة عن سوء الاستخدام، الإهمال، التعديل غير المصرّح به، أو التشغيل المخالف لتعليمات الشركة المصنعة.'] },
    { title: 'الاستبدال الكامل', paragraphs: ['يتم استبدال الطابعة كاملة فقط في حال ثبوت وجود ضرر ناتج عن الشحن أو النقل، وذلك بعد فحص المنتج وإصدار تقرير فني معتمد يثبت أن الضرر لم يكن نتيجة استخدام المستخدم.'] },
    { title: 'التأمين', paragraphs: ['قيمة التأمين والضمان الأساسي مشمولة ضمن سعر المنتج، ولا يتم احتسابها أو استردادها بشكل منفصل.'] },
