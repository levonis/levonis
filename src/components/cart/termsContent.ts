...
const ar: TermsContent = {
  ...
  sections: [
    ...
    { title: 'الفحص عند الاستلام', paragraphs: ['يلتزم المستخدم بفحص المنتج بشكل ظاهري أمام مندوب التوصيل قبل التوقيع، والإبلاغ الفوري عن أي ضرر ظاهر، نقص، اختلاف في اللون، أو خطأ في الكمية أو الخيارات. ويُعد توقيع الاستلام إقراراً بمطابقة الطلب لما هو مسجل في صفحة الطلب داخل الموقع.', 'الأعطال الفنية الخفية التي لا تظهر بالفحص الظاهري يجب الإبلاغ عنها خلال مدة لا تتجاوز 48 ساعة من تاريخ الاستلام مع تقديم صور أو فيديو يوضح الحالة. وفي حال عدم الإبلاغ خلال هذه المدة، يُعتبر المنتج مستلماً وعاملاً بحالة سليمة، ويسقط حق الاعتراض على الحالة الظاهرية أو الكمية.'] },
...
const en: TermsContent = {
  ...
  sections: [
    ...
    { title: 'Cancellation & refunds', paragraphs: ['If the user wishes to cancel or request a refund without a substantial technical reason or proven manufacturing defect, the platform may deduct administrative and operational fees including — but not limited to — order processing costs, bank transfers, supplier reservation fees, and any logistical commitments.', 'The deduction varies by execution stage, and the user agrees these fees cannot be disputed after accepting the terms.', 'Returns after delivery: the user may request a return within (7) days from the actual delivery date, exclusively if the delivered product does not match what is recorded in the product/order page on the site (quantity, color, option, specs, or a visible manufacturing defect), and provided the product is in its original condition with full packaging and accessories and has not been used. Change of mind or personal taste is not a valid return reason.', 'Any order, agreement, or modification made outside the site (private contact, external messages, verbal arrangements, or anything not recorded in the order page on the site) is not the platform’s responsibility, and the user has no right to any refund, compensation, or warranty for it.'] },
    { title: 'Pre-shipping inspection & packing', paragraphs: ['All products undergo a thorough inspection by the platform team before shipping: verifying quantity, colors, selected options/specs from the product page, included accessories, an initial power-on test for electronic devices, and integrity of inner and outer packaging.', 'An internal inspection record is kept as the official reference in any later dispute. The order is presumed to match what the user requested on the site unless proven otherwise with documented evidence.'] },
    { title: 'Shipping & delivery', paragraphs: ['Printers and accessories are shipped via approved carriers or delivery agents; some parts or accessories may ship by air within an estimated period of up to two weeks, with a minimum air-shipping weight of one (1) kg.', 'The platform is not responsible for any delays caused by third parties such as carriers, customs, or road/region conditions.', 'The user must inspect the order in front of the delivery agent before signing for receipt. Any difference in quantity, color, option, or specifications must be noted and documented (photo/video + refusing receipt or noting it with the agent) at that moment only. If the delivered item matches what is recorded in the order page on the site and no objection was raised in front of the agent, the user forfeits the right to later object to the visible contents.'] },
    { title: 'Full replacement & transit damage', paragraphs: ['The full printer is replaced only if shipping/transport damage is proven, conditional on immediate reporting in front of the delivery agent with photographic documentation, and after inspection and a certified technical report from the platform confirming the damage was not caused by the user or improper storage after receipt.', 'Damage discovered after signing for receipt without documentation in front of the agent is not considered shipping damage and is handled under the standard warranty terms.'] },
    { title: 'Basic warranty & activation requirements', paragraphs: ['The basic printer warranty starts from the purchase date, not the delivery date.', 'The warranty covers replacement of damaged parts only within the approved warranty period and does not cover faults caused by misuse, neglect, unauthorized modification, or operation contrary to the manufacturer’s instructions.', 'Activation and use of the warranty require: (1) the printer being registered in the platform system and linked to the same user’s account via the "Warranty Activation" feature and serial number, (2) the user bringing the printer itself to the platform’s official warehouse or office for technical inspection, (3) the printer not being opened or modified by any unauthorized party, (4) the user keeping the purchase invoice.', 'No part is replaced and no monetary compensation is paid before the technical inspection at the platform is completed. Any printer not registered in the user’s account or not inspected by the platform forfeits all warranty and compensation rights.', 'Monetary compensation in place of repair or replacement is at the platform’s sole discretion; the user cannot dictate the form of compensation.'] },
    ...
    { title: 'Inspection on receipt', paragraphs: ['The user must visually inspect the product in front of the delivery agent before signing and immediately report any visible damage, shortage, color mismatch, or wrong quantity/option. Signing for receipt is an acknowledgment that the order matches what is recorded in the order page on the site.', 'Hidden technical faults not detectable by visual inspection must be reported within 48 hours of delivery with photos/video. If not reported within that window, the product is considered received in good and working condition, and any objection to its visible state or quantity is forfeited.'] },
