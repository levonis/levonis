...
export default function EmojiPicker({ onSelectEmoji, className }: EmojiPickerProps) {
  ...
  return (
    <ScrollArea className={cn("h-80 bg-card rounded-2xl shadow-xl border", className)}>
      <div className="flex flex-col">
        {/* Header */}
        <div className="px-3 py-2 border-b bg-muted/30 sticky top-0 z-10 backdrop-blur-sm">
