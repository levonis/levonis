  ...
  return (
    <div className="relative w-full">
      <div
        ...
        className={cn(
          "min-h-[42px] max-h-24 overflow-y-auto rounded-full px-4 py-2.5 glass-chat-input border focus:ring-1 focus:ring-ring focus:outline-none text-sm leading-relaxed text-foreground",
