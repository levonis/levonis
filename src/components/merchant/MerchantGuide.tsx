...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  {
    icon: Gift,
    title: "الهدايا والسحوبات",
    emoji: "🎁",
    sectionKey: "giveaways",
    color: "text-pink-500",
    bgColor: "bg-pink-500/10",
    borderColor: "border-pink-500/20",
    gradientFrom: "from-pink-500/20",
    gradientTo: "to-pink-500/5",
    description: "أنشئ سحوبات وهدايا لزيادة تفاعل العملاء وجذب متابعين جدد. أداة تسويقية قوية لمتجرك.",
    steps: [
      { icon: PartyPopper, text: "إنشاء سحب جديد — حدد الجائزة، عدد الفائزين، وتاريخ السحب" },
      { icon: Ticket, text: "تذاكر المشاركة — العملاء يحصلون على تذاكر عند الشراء أو التفاعل مع منتجاتك" },
      { icon: Trophy, text: "اختيار الفائزين — تلقائي وعشوائي لضمان العدالة والشفافية" },
      { icon: Bell, text: "إشعارات تلقائية — يتم إبلاغ الفائزين فوراً عبر المنصة" },
      { icon: Users, text: "زيادة المتابعين — السحوبات تجذب عملاء جدد لمتجرك" },
      { icon: Eye, text: "متابعة الإحصائيات — عدد المشاركين، التذاكر المباعة، التفاعل" },
    ],
    proTips: [
      "اجعل الجائزة من أفضل منتجاتك لجذب اهتمام حقيقي",
      "حدد مدة السحب بـ 3-7 أيام — كافية للانتشار دون أن تطول",
      "شارك رابط السحب على وسائل التواصل لأقصى انتشار",
      "أنشئ سحب شهري لبناء قاعدة عملاء مخلصين",
    ],
    example: {
      title: "مثال ناجح",
      text: "تاجر أنشأ سحب على منتج بقيمة 25,000 → شارك 150+ عميل → زادت مبيعاته 60% خلال أسبوع السحب! 🎉",
      icon: TrendingUp,
    },
  },
  {
    icon: Radio,
    title: "إعلانات المتجر المدفوعة",
    emoji: "📢",
    sectionKey: "ads",
    color: "text-rose-500",
    ...
    description: "روّج لمتجرك بالإعلانات المدفوعة. يظهر متجرك في أعلى قائمة التجار لجذب المزيد من العملاء.",
    steps: [
      { icon: Megaphone, text: "حجز مساحة إعلانية — اختر الموقع المفضل في صفحة التجار الرئيسية" },
      { icon: Clock, text: "تحديد مدة الإعلان بالساعات — ادفع فقط على المدة التي تحتاجها" },
      { icon: DollarSign, text: "أسعار مرنة — تختلف حسب موقع الإعلان (الأول أغلى من الثالث)" },
      { icon: Eye, text: "ظهور مميز — متجرك يظهر بشكل بارز مع شارة 'إعلان' للمصداقية" },
      { icon: BarChart3, text: "تتبع الأداء — عدد المشاهدات والزيارات خلال فترة الإعلان" },
      { icon: Wallet, text: "الدفع من رصيد المحفظة — بدون حاجة لبطاقة بنكية" },
    ],
    proTips: [
      "أعلن في أوقات الذروة (المساء 7-11) لأقصى مشاهدات",
      "جهّز منتجات جديدة قبل الإعلان لاستقبال الزوار",
      "المركز الأول يحصل على 3 أضعاف المشاهدات مقارنة بالثالث",
    ],
    example: {
      title: "حساب التكلفة",
      text: "إعلان 6 ساعات في المركز الأول × 500 د.ع/ساعة = 3,000 د.ع فقط → ظهور مميز لمئات العملاء! 📊",
      icon: CircleDollarSign,
    },
  },
  {
    icon: ShoppingCart,
    title: "سلة التسوق المجتمعية",
    emoji: "🛒",
    sectionKey: "cart",
    color: "text-teal-500",
    ...
    description: "العملاء يضيفون منتجاتك للسلة ويتمون الشراء بسهولة. نظام سلة متكامل مع خيارات دفع متعددة.",
    steps: [
      { icon: ShoppingBag, text: "العميل يضيف منتجاتك للسلة — من صفحة المنتج أو من متجرك مباشرة" },
      { icon: Layers, text: "سلة منفصلة لكل تاجر — العميل يرى منتجاتك مجمّعة معاً" },
      { icon: Tag, text: "تطبيق الكوبونات — العملاء يستخدمون أكواد الخصم عند الدفع" },
      { icon: CreditCard, text: "خيارات دفع متعددة — كامل، نصف، ربع، أو عند الاستلام" },
      { icon: MapPin, text: "اختيار عنوان التوصيل — العميل يختار من عناوينه المحفوظة" },
      { icon: Bell, text: "إشعار فوري بالطلب — تصلك رسالة عند إتمام العميل للشراء" },
      { icon: MessageCircle, text: "محادثة مباشرة — العميل يتواصل معك بعد الطلب لأي استفسار" },
    ],
    proTips: [
      "أضف صوراً جذابة — المنتجات بصور واضحة تُضاف للسلة أكثر بـ 3 أضعاف",
      "فعّل التوصيل المجاني لزيادة حجم السلة",
      "أضف وصفاً واضحاً للمنتج لتقليل الاستفسارات",
    ],
    example: {
      title: "تجربة الشراء",
      text: "عميل يتصفح متجرك → يضيف 3 منتجات للسلة → يختار الدفع نصف المبلغ → يحدد العنوان → طلب جاهز! ✅",
      icon: CheckCircle2,
    },
  },
  {
    ...
    description: "أنشئ كوبونات خصم وعروض خاصة لجذب العملاء وزيادة المبيعات. أداة تسويقية فعالة جداً.",
    steps: [
      { icon: Tag, text: "إنشاء كوبون خصم — حدد الكود والنسبة والصلاحية" },
      { icon: BadgePercent, text: "نوع الخصم — نسبة مئوية (مثل 10%) أو مبلغ ثابت (مثل 5,000 د.ع)" },
      { icon: Clock, text: "فترة صلاحية — حدد تاريخ البداية والنهاية للعرض" },
      { icon: Users, text: "حد الاستخدام — مرة واحدة لكل عميل أو عدد محدود" },
      { icon: Sparkles, text: "عروض خاصة — خصم على منتجات معينة أو على كل المتجر" },
      { icon: Share2, text: "مشاركة الكوبون — شاركه على وسائل التواصل أو في رسائل المتجر" },
    ],
    proTips: [
      "كوبونات بنسبة 10-20% تحقق أفضل توازن بين الجذب والربح",
      "أنشئ كوبون ترحيبي للعملاء الجدد لتشجيعهم على أول شراء",
      "كوبونات بصلاحية قصيرة (3 أيام) تخلق شعور الاستعجال",
      "تابع عدد استخدامات الكوبون لقياس فعاليته",
    ],
    example: {
      title: "استراتيجية الكوبونات",
      text: "كوبون 'WELCOME15' بخصم 15% لأول 20 عميل → 18 استخدام خلال يومين → 18 عميل جديد! 🎯",
      icon: Target,
    },
  },
  {
    icon: Gauge,
    title: "لوحة التحكم الاحترافية",
    emoji: "📊",
    ...
    description: "لوحة تحكم شاملة تعرض جميع إحصائيات متجرك في مكان واحد. تابع أداءك واتخذ قرارات ذكية.",
    steps: [
      { icon: BarChart3, text: "إحصائيات المبيعات — إجمالي الإيرادات، عدد الطلبات، متوسط قيمة الطلب" },
      { icon: TrendingUp, text: "مؤشرات الأداء — مقارنة أداء الشهر الحالي بالسابق" },
      { icon: Package, text: "حالة الطلبات — كم طلب جديد، قيد التنفيذ، مكتمل، ملغي" },
      { icon: Star, text: "متوسط التقييم — تقييمك العام وآخر التقييمات" },
      { icon: Users, text: "إحصائيات العملاء — عدد العملاء الجدد والمتكررين" },
      { icon: Wallet, text: "رصيد المحفظة — الرصيد المتاح والديون والعمولات" },
      { icon: Eye, text: "زيارات المتجر — كم شخص زار متجرك ومنتجاتك" },
      { icon: FileText, text: "تقارير تفصيلية — تصدير البيانات لمراجعتها" },
    ],
    proTips: [
      "راجع لوحة التحكم يومياً لمتابعة الطلبات الجديدة",
      "قارن أداءك الشهري لتحديد الأنماط والفرص",
      "ركّز على المنتجات الأكثر مبيعاً وأضف منتجات مشابهة",
    ],
    example: {
      title: "قراءة الإحصائيات",
      text: "لاحظت أن مبيعات الإكسسوارات تزيد 50% يوم الجمعة → بدأت تنشر عروض خاصة كل جمعة → زيادة 30% في الإيرادات! 📈",
      icon: Lightbulb,
    },
  },
  {
    ...
    description: "نظام شكاوى عادل يحمي حقوق التاجر والعميل. تعامل مع الشكاوى باحترافية للحفاظ على سمعتك.",
    steps: [
      { icon: Shield, text: "حماية التاجر — النظام يوثّق كل المحادثات والاتفاقات كدليل" },
      { icon: MessageSquare, text: "التواصل مع الدعم — فريق الدعم يتدخل في حال حدوث خلاف" },
      { icon: FileText, text: "تقديم الأدلة — أرفق صور ومحادثات لدعم موقفك" },
      { icon: Clock, text: "سرعة الحل — معظم الشكاوى تُحل خلال 24-48 ساعة" },
      { icon: ShieldCheck, text: "قرارات عادلة — فريق محايد يراجع كل حالة بعناية" },
      { icon: Award, text: "سجل نظيف — عدم وجود شكاوى يرفع ترتيبك وثقة العملاء" },
    ],
    proTips: [
      "وثّق كل اتفاق مع العميل في المحادثة (السعر، الوقت، المواصفات)",
      "صوّر المنتج قبل التسليم كدليل على الجودة",
      "استجب لأي شكوى بهدوء واحترافية",
      "تجنب الشكاوى بالتواصل الواضح والتوقعات الصحيحة",
    ],
    example: {
      title: "تجنب الشكاوى",
      text: "قبل البدء بالعمل: وضّح السعر + وقت التسليم + المواصفات بالتفصيل في المحادثة → صوّر المنتج النهائي → أرسله للعميل قبل التسليم → صفر شكاوى! ✅",
      icon: Shield,
    },
  },
  {
    icon: Heart,
    title: "بناء قاعدة العملاء",
    emoji: "💜",
    ...
    description: "العملاء المخلصون هم أساس نجاحك. تعلّم كيف تبني علاقات طويلة الأمد وتحوّل المشترين لعملاء دائمين.",
    steps: [
      { icon: UserPlus, text: "جذب عملاء جدد — منتجات مميزة + صور جذابة + أسعار تنافسية" },
      { icon: MessageCircle, text: "خدمة عملاء ممتازة — استجب بسرعة وبلطف لكل استفسار" },
      { icon: Gift, text: "هدايا ومفاجآت — أضف هدية صغيرة مع الطلب لتكسب ولاء العميل" },
      { icon: BadgePercent, text: "خصومات للعملاء المتكررين — كوبون خاص لمن يشتري للمرة الثانية" },
      { icon: Star, text: "اطلب التقييم — بعد التسليم الناجح، شجّع العميل على التقييم" },
      { icon: Share2, text: "التسويق بالمحتوى — شارك قصص منتجاتك وعملية التصنيع" },
      { icon: Instagram, text: "وسائل التواصل — تواجد نشط على انستغرام وفيسبوك يجذب عملاء" },
    ],
    proTips: [
      "أرسل رسالة شكر بعد كل طلب مكتمل",
      "أضف بطاقة شخصية مع المنتج (اسم المتجر + رابط)",
      "انشر قصص العملاء السعداء (بموافقتهم)",
      "العميل الراضي يجلب 3 عملاء جدد في المتوسط",
    ],
    example: {
      title: "بناء الولاء",
      text: "أضفت بطاقة شكر صغيرة + كوبون 10% للشراء القادم مع كل طلب → 35% من العملاء عادوا للشراء مرة أخرى! 💜",
      icon: Heart,
    },
  },
];
...
const GETTING_STARTED = [
  ...
  { step: "6", text: "أنشئ كوبون ترحيبي — خصم 10% لأول 10 عملاء", icon: Percent, emoji: "🏷️" },
  { step: "7", text: "أنشئ أول سحب — لجذب عملاء جدد لمتجرك", icon: Gift, emoji: "🎁" },
  { step: "8", text: "شارك متجرك — على حساباتك في وسائل التواصل", icon: Share2, emoji: "📢" },
];
...
const FAQ_ITEMS = [
  ...
  { q: "كيف أنشئ سحب؟", a: "من لوحة التحكم → السحوبات → إنشاء سحب جديد. حدد الجائزة والمدة وعدد الفائزين.", icon: Gift },
  { q: "كيف أعمل إعلان لمتجري؟", a: "من لوحة التحكم → الإعلانات → حجز مساحة. اختر المركز والمدة وادفع من المحفظة.", icon: Radio },
  { q: "كيف أنشئ كوبون خصم؟", a: "من لوحة التحكم → الخصومات → إنشاء كوبون. حدد النسبة والكود وفترة الصلاحية.", icon: Percent },
  { q: "كيف يشتري العميل من سلتي؟", a: "العميل يضيف منتجاتك للسلة → يختار طريقة الدفع → يحدد العنوان → يصلك إشعار بالطلب فوراً.", icon: ShoppingCart },
  { q: "ماذا أفعل إذا وصلتني شكوى؟", a: "استجب بهدوء، قدم الأدلة (صور + محادثات)، تواصل مع الدعم. معظم الحالات تُحل بالتراضي.", icon: AlertTriangle },
