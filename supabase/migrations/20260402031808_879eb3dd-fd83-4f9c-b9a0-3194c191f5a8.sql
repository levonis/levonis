CREATE OR REPLACE FUNCTION public.cancel_order(p_order_id uuid, p_cancelled_by text DEFAULT 'admin')
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  -- Admin can cancel from any status except already cancelled
