...
BEGIN
  ...
  FOR i IN 1..p_quantity LOOP
    INSERT INTO user_purchased_products (
      user_id, product_id, competition_id, product_name, product_name_ar,
      product_image, product_price, gift_tickets, source_type, currency
    )
    VALUES (
      current_user_id, comp_record.product_id, p_competition_id,
