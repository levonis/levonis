  ...
  LOOP
    ...
    FOR v_unit IN 1..v_oi.quantity LOOP
      ...
      IF v_offer.sale_type = 'direct' THEN
        ...
        -- Resolve option_id: key may be a UUID or a name (ar/en)
        v_option_id := NULL;
        BEGIN
...
-- Backfill the stuck order
DO $$
BEGIN
  PERFORM public.finalize_and_reveal_rf_for_order('05413ce6-a1a2-47f6-86c3-0c72e84ff8e3', NULL);
EXCEPTION WHEN OTHERS THEN
