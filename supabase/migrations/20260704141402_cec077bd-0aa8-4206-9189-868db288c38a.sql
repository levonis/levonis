...
REVOKE ALL ON FUNCTION public.admin_regen_levo_card_secrets(uuid) FROM public, anon;
GRANT EXECUTE ON FUNCTION public.admin_regen_levo_card_secrets(uuid) TO authenticated;
