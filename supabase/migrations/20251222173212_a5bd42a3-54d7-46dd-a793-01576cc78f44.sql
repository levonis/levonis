-- Update enter_collect_letters_competition to support ticket rewards
...
BEGIN
  ...
  -- [better_luck_prob to better_luck_prob + ticket_rewards_prob) = ticket rewards
  -- [better_luck_prob + ticket_rewards_prob to better_luck_prob + ticket_rewards_prob + letter1_prob) = letter 1
  -- etc.
  -- If total < 100, the remainder is also better luck
