-- 1. Add category_id to offers (nullable = global for sale_type)
...
CREATE INDEX IF NOT EXISTS idx_rf_offers_category ON public.random_filament_offers(category_id, sale_type, enabled, display_order);

-- 2. Update RPC to validate offer matches the chosen category
