-- Create function to handle payment status change notifications
...
-- Create trigger for payment status change
DROP TRIGGER IF EXISTS on_payment_status_change ON public.orders;
