...
BEGIN
  ...
  INSERT INTO public.cart_items (
    user_id, product_id, product_option_id, quantity,
    selected_color, color_image_url,
    is_locked, sale_type
  ) VALUES (
    v_user, v_product.id, v_option.id, 1,
  ...
  INSERT INTO public.random_filament_orders (
    user_id, offer_id, category_id, product_id, product_option_id,
    selected_color, price_iqd, cart_item_id, sale_type
  ) VALUES (
    v_user, v_offer.id, p_category_id, v_product.id, v_option.id,
    v_color_name, v_offer.price_iqd, v_cart_item_id, v_sale_type
  )
