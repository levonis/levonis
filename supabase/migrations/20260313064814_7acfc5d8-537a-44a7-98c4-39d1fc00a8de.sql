...
-- Fix: Skip individual Telegram notifications for general/bulk notifications
-- (like new competition announcements) since they are already sent via notify-competition-telegram
...
BEGIN
  -- Skip general/bulk notifications - these are handled by dedicated bulk notification functions
  -- (e.g. notify-competition-telegram sends bulk Telegram for new competitions)
