-- Change points_per_block to numeric to support decimals like 0.1
ALTER TABLE public.stack_game_settings
  ALTER COLUMN points_per_block TYPE numeric USING points_per_block::numeric;

-- Update end_stack_game to handle decimal points_per_block
...
BEGIN
  ...
  -- Calculate GAME score (for leaderboard)
  ...
  -- Calculate WEBSITE points (decimal points_per_block supported, floor the result)
