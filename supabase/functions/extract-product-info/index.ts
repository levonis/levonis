...
- تحليل صور الألوان واستخراج درجة اللون الدقيقة (hex code) من الصورة نفسها
...
- عند استخراج الألوان: قم بتحليل الصورة واستخراج اللون الفعلي الظاهر في المنتج وحدد hex code دقيق له
...
4. جميع الألوان المتوفرة مع:
   - اسم اللون بالعربية والإنجليزية
   - صورة تظهر المنتج بهذا اللون
   - تحليل الصورة واستخراج hex code دقيق للون الظاهر في المنتج
                  ...
                  colors: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        hex_code: { type: "string", description: "كود اللون hex مستخرج من تحليل الصورة - يجب أن يكون دقيقاً ويمثل اللون الفعلي الظاهر في صورة المنتج (مثال: #FF0000 للأحمر الساطع، #8B0000 للأحمر الداكن، #FFB6C1 للوردي الفاتح)" },
                        image_url: { type: "string", description: "رابط صورة تظهر نفس المنتج بالضبط ولكن بهذا اللون المحدد - يجب أن تكون نفس الشكل والتصميم مع اختلاف اللون فقط. استخدم هذه الصورة لاستخراج hex code الدقيق" }
                      }
                    },
