...
- **الألوان - مهم جداً**: يجب استخراج **جميع** الألوان المتوفرة بدون استثناء. اقرأ الصفحة بالكامل وابحث عن كل لون مذكور
...
- **لا تختصر**: إذا كان هناك 50 لوناً، استخرج جميع الـ 50 لوناً
- **لا تتوقف**: استمر في القراءة حتى تجد جميع الألوان المذكورة في الصفحة

📍 **استخراج الألوان - تعليمات خاصة:**
1. ابحث في جميع أقسام الصفحة عن أسماء الألوان
2. ابحث عن قوائم الألوان، خيارات الألوان، جداول الألوان
3. تأكد من استخراج كل لون مع اسمه الكامل
4. إذا وجدت قائمة ألوان طويلة، استخرج جميع العناصر فيها
5. تحقق مرتين من أنك لم تفوت أي لون
...
4. الألوان المتوفرة - **مهم جداً: استخرج جميع الألوان بدون استثناء**:
   🔴 **تنبيه حرج**: يجب استخراج **كل** لون موجود في الصفحة، حتى لو كان هناك 50 أو 100 لون!
   ...
   📋 **خطوات استخراج الألوان:**
   1. ابحث عن قسم "الألوان" أو "Colors" في الصفحة
   2. اقرأ جميع أسماء الألوان المذكورة
   3. لا تتوقف عند عدد معين - استخرج كل الألوان
   4. إذا وجدت قائمة طويلة، استخرج كل عنصر فيها
   5. تحقق مرة أخرى أنك لم تفوت أي لون
