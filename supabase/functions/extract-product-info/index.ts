...
- الأحجام/الخيارات: فقط الخيارات الفعلية المتوفرة (S, M, L, XL, 32, 34, 36، قطن، حرير، etc.)
- الألوان: استخرج فقط الألوان المعروضة بوضوح مع صورها
...
3. الأحجام/الخيارات:
   ...
   - أمثلة: S, M, L, XL أو 1kg, 2kg أو قطن، حرير

4. الألوان المتوفرة (كل لون يجب أن يحتوي على):
   - اسم اللون بالعربية (طبيعي ومفهوم)
   - اسم اللون بالإنجليزية (من الصفحة)
                ...
                properties: {
                  ...
                  sizes: {
                    ...
                    items: {
                      type: "object",
                      properties: {
                        name: { type: "string", description: "الحجم/الخيار بالإنجليزية - الاسم الأصلي من الصفحة (أمثلة: S, M, L, XL, 32, 34, 1kg, Cotton, Silk)" },
                        name_ar: { type: "string", description: "الحجم/الخيار بالعربية - ترجمة طبيعية ومفهومة (أمثلة: صغير، وسط، كبير، 1 كيلوجرام، قطن، حرير)" },
                    ...
                    description: "جميع الأحجام/الخيارات المتوفرة للمنتج - منفصلة تماماً عن الألوان. استخدم هذا فقط للخيارات التي ليست ألواناً (مثل: أحجام، أوزان، خامات، أنواع). إذا لم توجد خيارات، أرجع مصفوفة فارغة []"
                  },
                  colors: {
                    type: "array",
                    items: {
                      type: "object",
                      properties: {
                        name: { type: "string", description: "اسم اللون بالإنجليزية - الاسم الأصلي من الصفحة (أمثلة: Red, Blue, Black, White, Green, Navy, Sky Blue)" },
                        name_ar: { type: "string", description: "اسم اللون بالعربية - ترجمة طبيعية ومفهومة (أمثلة: أحمر، أزرق، أسود، أبيض، أخضر، أزرق بحري، أزرق سماوي)" },
                    ...
                    description: "جميع الألوان المتوفرة للمنتج مع صورة ودرجة لون دقيقة لكل لون. استخدم هذا فقط للألوان الفعلية وليس للأحجام أو أي خيارات أخرى. كل لون يجب أن يكون له صورة واضحة و hex code دقيق. إذا لم توجد ألوان، أرجع مصفوفة فارغة []"
                  },
                  features: {
                    type: "array",
                    items: {
